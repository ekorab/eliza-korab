...
/**
 * Ramka zawieraj¹ca ustawienia dotycz¹ce wyboru ró¿nych okien dialogowych opcji
 */
public class OptionDialogFrame extends JFrame
{
   ...
   public OptionDialogFrame()
   {
      ...
      inputPanel = new ButtonPanel("Dane wejœciowe", "Text field", "Combo box");
    ...
    * @return ³añcuch, ikona, komponent lub tablica obiektów, w zale¿noœci od wyboru w panelu Komunikat
    */
    ...
    * @return tablica ³añcuchów, ikon lub obiektów, w zale¿noœci od wyboru w panelu Opcja
    */
    ...
    * @return wybrana sta³a XXX_MESSAGE lub XXX_OPTION z klasy JOptionPane
    */
   ...
   /**
    * S³uchacz akcji przycisku Poka¿ wyœwietla okno dialogowe potwierdzenia, danych wejœciowych, komunikatu lub opcji,
    * w zale¿noœci od wyboru typu panelu.
